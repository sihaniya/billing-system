    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3">Edit Invoice Item</h1>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-12 col-md-6">
                                    <!-- start: form -->
                                    <form method="post" action="?action=invoiceItemUpdate">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example"
                                                ...
                                                <option value="<?= $invoice['id'] ?>" <?php if ($invoice['id'] == $invItem['invoice_id']) {
                                                                                                echo 'selected';
                                                                                            } ?>>
                                                    <?= $invoice['id'] ?></option>
                                                <?php } ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example"
                                                ...
                                                <option value="<?= $product['id'] ?>" <?php if ($product['id'] == $invItem['product_id']) {
                                                                                                echo 'selected';
                                                                                            } ?>>
                                                    <?= $product['product'] ?>
                                                </option>
